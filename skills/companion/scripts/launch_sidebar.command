#!/bin/bash
# This file is opened by Terminal.app directly — no permissions needed
...
if [ -z "$TOKEN" ]; then
    ...
    # Run setup-token and capture output, then parse token in Python
    # (handles line wrapping and avoids shell regex pitfalls)
